...
interface Libmupdf {
	...
	_wasm_get_graphics_min_line_width(): number,
	_wasm_set_graphics_aa_level(bits: number): void,
	_wasm_get_graphics_aa_level(): number,
	_wasm_set_text_aa_level(bits: number): void,
	_wasm_get_text_aa_level(): number,
